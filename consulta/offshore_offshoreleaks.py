...
def consultar_offshore_offshoreleaks(nombre_completo, folder):
    resultados = []
    archivo_base = os.path.join(folder, "offshore_offshoreleaks")

    with sync_playwright() as p:
        browser = p.chromium.launch(headless=False)
        page = browser.new_page()

        print("[INFO] Abriendo Offshore Leaks investigacion...")
        page.goto("https://offshoreleaks.icij.org/investigations/offshore-leaks", wait_until="networkidle")
